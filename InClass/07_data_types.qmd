...
pretty_data[[c("dates", "more_numbers")]] #This would give us an error because you can only request one column at a time with double square brackets
pretty_data[[2]][[3]] # Gives the third value from the second column (cant go any deeper)
pretty_data[[2]][3] # Gives the third value from the second column
pretty_data[[2]][c(TRUE, FALSE, TRUE)] #Gives us 1 and 3 in the second column
pretty_data[[1]][c(1, 2, 1, 2)] #This would give us True,False,True,False
```
